...
class AbstractAWSProvider extends AbstractProvider {
   ...
   */
  getConfigFields() {
    return ConfigFieldBuilder.buildAll([ConfigFieldBuilder.text('access_key_id').label((0,external_wp_i18n_namespaceObject.__)('Access Key ID', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('S3-compatible API access key ID', 'aether')).required().min(16).max(128), ConfigFieldBuilder.password('secret_access_key').label((0,external_wp_i18n_namespaceObject.__)('Secret Access Key', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('S3-compatible API secret access key (encrypted)', 'aether')).required().sensitive().min(32).max(128), ConfigFieldBuilder.text('bucket_name').label((0,external_wp_i18n_namespaceObject.__)('Bucket Name', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Bucket name for file storage', 'aether')).required().pattern('^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$', (0,external_wp_i18n_namespaceObject.__)('Bucket name must be 3-63 characters, lowercase, start/end with alphanumeric', 'aether')).min(3).max(63), ConfigFieldBuilder.text('region').label((0,external_wp_i18n_namespaceObject.__)('Region (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Storage region (e.g., us-east-1, auto)', 'aether')), ConfigFieldBuilder.url('endpoint').label((0,external_wp_i18n_namespaceObject.__)('Endpoint URL (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Custom endpoint URL for S3-compatible storage', 'aether'))]);
  }
...
class CloudflareR2Provider extends AbstractAWSProvider {
  ...
  getConfigFields() {
    ...
    const r2Fields = ConfigFieldBuilder.buildAll([ConfigFieldBuilder.text('cloudflare_account_id').label((0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Your Cloudflare account ID (found in R2 dashboard)', 'aether')).required().pattern('^[a-f0-9]{32}$', (0,external_wp_i18n_namespaceObject.__)('Account ID must be a 32-character hexadecimal string', 'aether')).sensitive(), ConfigFieldBuilder.url('worker_endpoint').label((0,external_wp_i18n_namespaceObject.__)('Worker Endpoint URL', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Deployed Cloudflare Worker endpoint for upload proxy (auto-populated after deployment)', 'aether')), ConfigFieldBuilder.url('custom_domain').label((0,external_wp_i18n_namespaceObject.__)('Custom Domain (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Custom domain for R2 bucket access (e.g., https://cdn.example.com)', 'aether')), ConfigFieldBuilder.checkbox('public_access').label((0,external_wp_i18n_namespaceObject.__)('Enable Public Access', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Allow public read access to bucket contents', 'aether')).default(false)]);
...
(0,external_wp_hooks_.addAction)('aether.providers.register', 'cloudflare-r2/register', registry => {
  registry.register(CloudflareR2Provider.ID, CloudflareR2Provider);
});

// Register the settings component via action hook
(0,external_wp_hooks_.addAction)('aether.admin.provider.settings', 'cloudflare-r2/settings', (providerId, container) => {
