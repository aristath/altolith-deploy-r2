...
async function deployWorker(accountId, apiToken, workerName, script, bindings = {}) {
  ...
  const authHeaders = (0,api/* createAuthHeaders */.ZB)(apiToken);
...
async function deleteWorker(accountId, apiToken, workerName) {
  ...
  const response = await fetch(url, {
    method: 'DELETE',
    headers: (0,api/* createAuthHeaders */.ZB)(apiToken)
  });
...
class CloudflareWorkersProvider extends AbstractProvider {
   ...
   */
  getConfigFields() {
    return ConfigFieldBuilder.buildAll([ConfigFieldBuilder.text('account_id').label((0,external_wp_i18n_namespaceObject.__)('Account ID', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Your Cloudflare account ID (found in Workers dashboard)', 'aether')).required().pattern('^[a-f0-9]{32}$', (0,external_wp_i18n_namespaceObject.__)('Account ID must be a 32-character hexadecimal string', 'aether')).sensitive(), ConfigFieldBuilder.password('api_token').label((0,external_wp_i18n_namespaceObject.__)('API Token', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Cloudflare API token with Workers permissions', 'aether')).required().sensitive().min(20)]);
  }
...
(0,external_wp_hooks_.addAction)('aether.providers.register', 'cloudflare/register', registry => {
  registry.register(CloudflareWorkersProvider.ID, CloudflareWorkersProvider);
});

// Register the settings component via action hook
(0,external_wp_hooks_.addAction)('aether.admin.provider.settings', 'cloudflare/settings', (providerId, container) => {
