 ...
 */
(0,external_wp_hooks_.addFilter)('aether.provider.test', 'aether/gitlab-pages', (handler, providerId, config) => {
  // Handle 'gitlab-pages' or 'gitlab-pages:uuid' format
  if (providerId !== 'gitlab-pages' && !providerId?.startsWith('gitlab-pages:')) {
    return handler;
  }
