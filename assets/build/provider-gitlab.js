...
(0,external_wp_hooks_.addAction)('aether.providers.register', 'gitlab/register', registry => {
  registry.register(GitLabProvider.ID, GitLabProvider);
});

// Register the settings component via action hook
(0,external_wp_hooks_.addAction)('aether.admin.provider.settings', 'gitlab/settings', (providerId, container) => {
