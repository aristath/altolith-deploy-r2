...
class GitLabProvider {
   ...
   * @type {string}
   */
  static NAME = (0,external_wp_i18n_namespaceObject.__)('GitLab (Experimental)', 'aether-site-exporter-providers');
   ...
   * @type {string}
   */
  static DESCRIPTION = (0,external_wp_i18n_namespaceObject.__)('Git-based file storage using GitLab repositories. Uses GitLab API for browser-based deployment.', 'aether-site-exporter-providers');
  ...
  static CONFIG_FIELDS = [{
    ...
    help: (0,external_wp_i18n_namespaceObject.__)('GitLab project ID. Either project_id or namespace+project_path is required.', 'aether-site-exporter-providers')
  }, {
    id: 'namespace',
    ...
    required: false,
    sensitive: false,
    help: (0,external_wp_i18n_namespaceObject.__)('Repository name/path within the namespace. Either project_id or namespace+project_path is required.', 'aether-site-exporter-providers')
  }, {
    id: 'branch',
...
registry_ProviderRegistry.register(GitLabProvider.ID, GitLabProvider);

// Also trigger the hook for any listeners
(0,external_wp_hooks_namespaceObject.doAction)('aether.providers.register', GitLabProvider);
 ...
 */
(0,external_wp_hooks_namespaceObject.addFilter)('aether.provider.test', 'aether/gitlab', (handler, providerId) => {
 ...
 */
(0,external_wp_hooks_namespaceObject.addFilter)('aether.provider.upload_strategy', 'aether/gitlab', (strategy, providerId) => {
  if (providerId?.startsWith('gitlab') && !providerId.startsWith('gitlab-pages')) {
    return 'git';
  }
  return strategy;
}, 10);
